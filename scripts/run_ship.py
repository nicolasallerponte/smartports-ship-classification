...
from smartports.experiment import run_experiment, DEFAULT_CFG

DATA_DIR   = Path(__file__).parent.parent / 'data'
OUTPUT_DIR = Path(__file__).parent.parent / 'outputs'

CSV_PATH = DATA_DIR / 'ship.csv'
...
def parse_args():
    parser = argparse.ArgumentParser(description='Ship/No-Ship classification experiment')

    parser.add_argument('--model', type=str, default=None,
                        choices=['simplecnn', 'convnext', 'resnet18'],
